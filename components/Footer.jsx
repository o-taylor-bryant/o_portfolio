...
export default function Footer() {
  return (
    <div className="flex justify-center items-center flex-col mt-5 overflow-hidden">
      <div className="flex justify-center items-center flex-col mt-5 self-center min-h-[40vh] border-b-2 min-w-[80vw]">
        <Link href="/#contact">
          <motion.h2
      ...
      <footer className="flex justify-center items-center flex-col my-5">
        <p className="text-gray-800 text-sm">
          &copy;{new Date().getFullYear()} —{" "}
          <span className="text-gray-700 text-lg">Taylor Bryant</span>
        </p>
      </footer>
    </div>
  );
