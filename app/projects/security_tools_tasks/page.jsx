...
export default function SecurityToolsTasks() {
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center items-center w-full">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                Security Tools & Tasks projects are currently in development.
                Check back soon for SIEM tools, network analysis, incident
                response procedures, and threat detection methodologies!
              </motion.p>
            </div>
        ...
        <div className="px-6 py-2 bg-neutral-200 border-t border-black/10 text-center text-xs text-black/40 relative flex items-center justify-center">
          <motion.span
            ...
            transition={{ duration: 3, repeat: Infinity }}
          >
            © 2025 Taylor Terminal • Security Tools & Tasks - Coming Soon
          </motion.span>
          <span
